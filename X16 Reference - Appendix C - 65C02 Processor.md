...
As a result, we recommend _not_ using the BBR, BBS, RMB and SMB instructions, as these
may become invalid in future versions of the Commander X16.

These instructions are _not_ supported on the Commander X16 as of the R47 release.
